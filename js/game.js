...
var noseOfJet;
var startSound = new Audio("https://bananakingwar.unlink.men/audio/start.mp3");
var winSound = new Audio("https://bananakingwar.unlink.men/audio/win.mp3");
var bgSound = new Audio("https://bananakingwar.unlink.men/audio/back.mp3");
var enemyKillSound = new Audio("https://bananakingwar.unlink.men/audio/bullet.wav");
var deathSound = new Audio("https://bananakingwar.unlink.men/audio/death.wav");
var fireSound = new Audio("https://bananakingwar.unlink.men/audio/fire.wav");
var speedInc = 0;
var jet1 = new Jet();
...
Jet.prototype.draw = function () {
    ...
    if(bulletStyle==2) {
        ctxJet.drawImage(imgSprite, 440, 500, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
    else if(bulletStyle==1) {
        ctxJet.drawImage(imgSprite, 593, 500, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
    else {
...
Jet.prototype.checkShootingLine = function () {
    ...
    if (this.isBKey && !this.isShootingLine) {
        this.isShootingLine = true;
        this.line.fire(this.noseX, 0);
    }
    else if (!this.isXKey && !this.isBKey) this.isShootingLine = false;
};
...
Bullet.prototype.draw = function () {
    this.drawX += 3;
    if(bulletStyle==1) {
        ctxJet.drawImage(imgSprite, 800, 500, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
    else if(bulletStyle==2) {
        ctxJet.drawImage(imgSprite, 565, 500, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
    else {
        ctxJet.drawImage(imgSprite, this.srcX, this.srcY, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
...
Enemy.prototype.draw = function () {
    ...
    if(bulletStyle==1) {
        ctxEnemy.drawImage(imgSprite, 297, this.srcY, this.width, this.height, this.drawX, this.drawY, this.width, this.height);
    }
    else {
